    ...
    public class GradeAnalyzer {
        ...
        /* My code finds the average score of students in a class
        I can always make better the functionalities as this is basic*/
        ...
        public double getAverage(ArrayList<Integer> grades){
            if(grades.size()<1){
                System.out.println("List is empty please");
                return 0.00;
        ...
        public int ishiro(ArrayList<Integer> scores){
